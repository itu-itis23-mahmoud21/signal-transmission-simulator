...
#
# 1) Gemini Optimized:
#    $env:TEST_TARGET="gemini_optimized"; pytest -q -s comm_sim/tests/test_d2a.py
#
# 2) GPT Optimized:
#    $env:TEST_TARGET="GPT_optimized"; pytest -q -s comm_sim/tests/test_d2a.py
#
# 3) Original (Default):
#    $env:TEST_TARGET="original"; pytest -q -s comm_sim/tests/test_d2a.py
